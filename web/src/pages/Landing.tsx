  ...
  const features = [
    {
      ...
      description:
        "Advanced brainwave visualization with live mental state analysis",
      image:
    ...
    },
    {
      ...
      description:
        "AI-powered cognitive exercises that adapt to your brain patterns",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive reports tracking your mental performance over time",
      image:
  ...
  const testimonials = [
    {
      ...
      content:
        "NeuroBridge represents a breakthrough in accessible neurofeedback technology. The real-time analysis is remarkably accurate.",
      avatar:
    ...
    },
    {
      ...
      content:
        "As someone with ADHD, NeuroBridge has transformed my ability to focus. The training modules are engaging and effective.",
      avatar:
    ...
    },
    {
      ...
      content:
        "I recommend NeuroBridge to my patients. The meditation guidance and stress reduction features are exceptional.",
      avatar:
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
      <nav className="w-full flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-900 shadow-md">
        ...
        <div className="flex space-x-4">
          <Link
            to="/signup"
            className="px-4 py-2 font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200"
          >
            Signup
          </Link>
          <Link
            to="/login"
            className="px-4 py-2 font-medium rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-gray-800 transition-all duration-200"
          >
            Login
          </Link>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced EEG monitoring and AI-powered training to enhance focus,
              reduce stress, and optimize your cognitive performance in
              real-time.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Experience the future of brain training with our
              scientifically-backed platform
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Compatible with popular EEG headsets like Muse, Emotiv, and OpenBCI",
                icon: Brain,
                color: "blue",
              },
              {
                ...
                description:
                  "Our AI analyzes your brainwaves and provides instant feedback on your mental state",
                icon: Zap,
                color: "purple",
              },
              {
                ...
                title: "Personalized Training",
                description:
                  "Adaptive exercises and recommendations based on your unique brain patterns",
                icon: Target,
                color: "green",
              },
            ].map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="relative mb-8">
                    <div
                      className={`w-20 h-20 mx-auto rounded-full bg-${item.color}-100 dark:bg-${item.color}-900/20 flex items-center justify-center mb-4`}
                    >
                      <Icon
                    ...
                    <div
                      className={`absolute -top-2 -right-2 w-8 h-8 bg-${item.color}-600 text-white rounded-full flex items-center justify-center text-sm font-bold`}
                    >
                      {item.step}
                    </div>
                  </div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Scientifically proven benefits for your cognitive health and
              performance
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Improve concentration and attention span by up to 40% with targeted training",
                stat: "40%",
                color: "blue",
              },
              {
                ...
                description:
                  "Lower cortisol levels and achieve deeper relaxation states",
                stat: "65%",
                color: "green",
              },
              {
                ...
                description:
                  "Accelerate information retention and cognitive processing",
                stat: "30%",
                color: "purple",
              },
              {
                ...
                description:
                  "Optimize brainwave patterns for better sleep quality",
                stat: "50%",
                color: "indigo",
              },
              {
                ...
                description:
                  "Achieve flow states and optimal mental performance",
                stat: "85%",
                color: "orange",
              },
              {
                ...
                description:
                  "Support long-term brain health and neuroplasticity",
                stat: "95%",
                color: "pink",
              },
            ].map((benefit, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-${benefit.color}-100 dark:bg-${benefit.color}-900/20 rounded-xl flex items-center justify-center mb-6`}
                  >
                    <Icon
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span
                      className={`text-2xl font-bold text-${benefit.color}-600 dark:text-${benefit.color}-400`}
                    >
                      +{benefit.stat}
                    </span>
                  </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See what researchers, professionals, and users say about
              NeuroBridge
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Revolutionizing brain training through advanced EEG technology
